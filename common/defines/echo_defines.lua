...
NDefines.NCountry.DISINHERIT_PRESTIGE_HIT = -10
NDefines.NCountry.NEW_HEIR_PRESTIGE_HIT = 0
...
NDefines.YEARS_OF_NATIONALISM = 20
...
NDefines.NMilitary.SIEGE_FORCE_NEEDED_MULTIPLIER =  0.5			-- x times garrison to be able to siege.
